...
| marketplace | customer model from orders (profiles, segments as an industry proxy, complements); personalised search and photo ranking as a tie-breaker; For-you strip with re-order prompts; `mcv simulate-market` measures the lift with and without the shop id on the same lookups: 1000 shops, 15k orders, search top-1 49% -> 66%, photo 82% -> 85%, industries recovered with purity 0.90 (2026-09-09) |
