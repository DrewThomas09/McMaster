...
| sizing | Measure tool and coin hint; nominal pipe size -> real OD/ID; nut width per thread size; thread pitch from the photo (NPT vs BSP, coarse vs fine); catalog-page importer. A quarter in the frame: photo top-1 80% -> 86%, 76% -> 84% on parts a shop never bought (synthetic marketplace, 2026-09-09) |
